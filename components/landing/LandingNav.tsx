      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="rounded-xl bg-white px-4 py-2 text-[13px] font-semibold text-[#0a0a0f] shadow-[0_0_24px_rgba(255,255,255,0.12)] transition-colors hover:bg-[#e5e5e5] sm:px-5"
          >
            Get started
          </button>
        </div>
