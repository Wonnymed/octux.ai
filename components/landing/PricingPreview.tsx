...
const tiers = [
  {
    ...
    features: ['5 Ink chats/day', '1 Deep sim/month', 'Basic verdict'],
    cta: 'Start free',
    popular: false,
  ...
  },
  {
    ...
    features: ['Unlimited Ink chat', 'Deep sims at $2.99 each', 'Full verdicts + citations'],
    cta: 'Get started',
    popular: false,
    color: 'text-txt-secondary',
  },
  {
    ...
    features: ['Unlimited Ink chat', '15 Deep sims/month', '1 Kraken token/month', 'Boardroom reports'],
    cta: 'Go Pro',
    popular: true,
    color: 'text-accent',
  },
  {
    ...
    features: ['Unlimited everything', '40 Deep + 3 Kraken/month', 'API access', 'Priority support'],
    cta: 'Go Max',
    popular: false,
    color: 'text-tier-max',
  },
