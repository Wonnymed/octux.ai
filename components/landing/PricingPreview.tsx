...
const tiers = [
  {
    ...
    features: ['3 Ink chats/day', '1 Deep sim/week', 'Basic verdict'],
    cta: 'Start free',
    popular: false,
  ...
  },
  {
    ...
    features: ['Unlimited Ink chat', 'Deep sims at $2 each', 'Full verdicts + citations'],
    cta: 'Get started',
    popular: false,
    color: 'text-txt-secondary',
  },
  {
    ...
    features: ['Unlimited Ink + Deep', '10 Kraken sims/month', 'Agent chat + memory', 'Boardroom reports'],
    cta: 'Go Pro',
    popular: true,
    color: 'text-accent',
  },
