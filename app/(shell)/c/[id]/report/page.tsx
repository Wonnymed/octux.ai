...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!supabase) return { title: 'Sukgo AI — Report Not Found' };
  ...
  return {
    title: `${question} — Sukgo Report`,
    description: `${rec} (${prob}%) — ${verdict?.one_liner || 'AI-powered decision analysis'}`,
    openGraph: {
      title: `${rec} (${prob}%) — ${question}`,
      description: verdict?.one_liner || 'Analyzed by 10 AI specialists on Sukgo',
    ...
    <div className="min-h-screen bg-white text-gray-900 print:bg-white">
      <div className="max-w-3xl mx-auto px-8 py-12 print:px-4 print:py-6">
        ...
        <div className="flex items-center justify-between mb-8 border-b border-gray-200 pb-6">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-sm font-light tracking-[0.15em] text-gray-400 lowercase">sukgo</span>
          ...
          <div className="print:hidden">
            <a href="/" className="text-sm text-accent hover:text-accent-hover">sukgo.ai →</a>
          </div>
        </div>
        ...
        <div className="text-center pt-6 border-t border-gray-200 print:hidden">
          <p className="text-sm text-gray-500 mb-3">Powered by Sukgo AI — 10 specialists debate your decisions</p>
          <a
            href="/"
        ...
        <div className="hidden print:block mt-12 pt-4 border-t border-gray-200">
          <p className="text-xs text-gray-400 text-center">Generated by sukgo.ai — Business Simulation Engine</p>
        </div>
      </div>
    </div>
  );
