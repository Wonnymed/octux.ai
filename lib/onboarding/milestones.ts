...
export const TIPS: Record<TipId, Tip> = {
  tip_simulate: {
    id: 'tip_simulate',
    text: "💡 Free plan includes 2 simulation tokens per month (swarm mode). Ask a specific question, pick a mode, then run a simulation when you're ready.",
  ...
  tip_free_limit_info: {
    ...
    text: '📊 Free tier includes chat and Swarm simulations. Specialist and advanced modes use tokens — upgrade to Pro for more.',
